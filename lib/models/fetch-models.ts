...
// provider so Nelth-3.5 (tencent/hy3:free) and Nelth-3.5 Thinking
...
export async function fetchOpenAIModels(): Promise<Model[]> {
  ...
  // Provider display name for OpenAI-sourced models (distinct from the
  // "openai-compatible" NVIDIA endpoint, which defines its own below).
