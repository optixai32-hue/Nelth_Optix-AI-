...
import { getLocalFileUrl } from './local-file-store'
...
export async function getSignedFileUrl(
  ...
  // Local fallback: when object storage is not configured, files live on disk
  // and are served via a direct route instead of a signed URL.
