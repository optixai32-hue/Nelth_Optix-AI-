...
export const SKILLS_MAIN_ROUTING: Record<string, SkillsMainRouting> = {
  'frontend-design': {
    ...
    triggers: [
      ...
      'créer un site',
      'creer un site',
      // All-language website vocabulary.
      'sitio web',
      'página web',
      'pagina web',
      'Webseite',
  ...
  'web-artifacts-builder': {
    ...
    triggers: [
      ...
      // All-language interactive-app vocabulary.
      'aplicación web',
      'aplicacion web',
      'aplicação web',
      'aplicacao web',
  ...
  'canvas-design': {
    ...
    triggers: [
      ...
      'bannière',
      'banniere',
      // All-language visual/canvas vocabulary.
      'diseño',
      'cartel',
      'Grafik',
      'Plakat',
  ...
  'algorithmic-art': {
    ...
    triggers: [
      ...
      'génératif',
      'generatif',
      // All-language generative-art vocabulary.
      'arte generativo',
      'generative Kunst',
      'arte generativa',
      '生成艺术',
  ...
  'game-developer': {
    ...
    triggers: [
      ...
      'quiz game',
      'jeu quiz',
      // All-language game vocabulary (ES DE IT PT MG AR ZH RU).
      'juego',
      'juegos',
      'jugar',
      'videojuego',
  ...
  docx: {
    ...
    triggers: [
      ...
      'letter',
      '.docx',
      // All-language document vocabulary (FR ES DE IT PT MG AR ZH RU).
      'lettre',
      'lettres',
      'courrier',
      'facture',
  ...
  pptx: {
    ...
    triggers: [
      ...
      'keynote',
      '.pptx',
      // All-language presentation vocabulary.
      'diaporama',
      'exposé',
      'expose',
      'presentación',
  ...
  xlsx: {
    ...
    triggers: [
      ...
      '.xlsx',
      'recalc',
      // All-language spreadsheet vocabulary.
      'tableur',
      'feuille de calcul',
      'classeur',
      'hoja de cálculo',
  ...
  pdf: {
    ...
    triggers: [
      ...
      'fillable',
      'pdf form field',
      // All-language PDF/document vocabulary.
      'facture',
      'fichier',
      'factura',
      'archivo pdf',
  ...
  'doc-coauthoring': {
    ...
    triggers: [
      ...
      'writing partner',
      'help me write',
      // All-language writing vocabulary.
      'rédiger',
      'rediger',
      'écrire',
      'ecrire',
