...
export const UserTextSection: React.FC<UserTextSectionProps> = ({
  ...
  return (
    <CollapsibleMessage role="user" showIcon={false}>
      <div
      ...
      >
        {isEditing ? (
          ...
          <div className="relative">
            ...
            <div
              className={cn(
                'absolute left-full top-1/2 -translate-y-1/2 ml-8 flex items-center gap-0.5 p-0.5 bg-background rounded-full shadow-sm border',
                'opacity-0 translate-x-1.5 transition-all duration-300 ease-out',
                'max-md:group-focus-within:opacity-100 max-md:group-focus-within:translate-x-0',
