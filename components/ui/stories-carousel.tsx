...
export const StoriesPrevious = ({ className, ...props }: StoriesNavProps) => (
  <CarouselPrevious
    type="button"
    className={cn(
      'left-1 top-1/2 -translate-y-1/2 z-20 size-7 bg-background/80 backdrop-blur',
      className
    )}
    {...props}
  />
...
export const StoriesNext = ({ className, ...props }: StoriesNavProps) => (
  <CarouselNext
    type="button"
    className={cn(
      'right-1 top-1/2 -translate-y-1/2 z-20 size-7 bg-background/80 backdrop-blur',
      className
    )}
    {...props}
  />
...
export const StoryOverlay = ({
  ...
  return (
    <div
      className={cn(
        'absolute right-0 left-0 h-20 from-black/50 to-transparent',
        positionClasses,
        className
      )}
      {...props}
