    ...
    <main className="mx-auto w-full max-w-3xl px-6 py-12">
      ...
      <div className="mt-8 space-y-6 text-sm leading-6 text-foreground/90">
        ...
        <section>
          ...
          <p className="mt-2">
            Connections are strictly <strong>read-only</strong> and only used to
            answer your own requests in the chat:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-6">
            <li>
              ...
              events — scopes <code>drive.readonly</code>,{' '}
              <code>gmail.readonly</code>, <code>calendar.readonly</code>,{' '}
        ...
        <section>
          <h2 className="text-lg font-semibold">3. How your data is used</h2>
          <p className="mt-2">
            ...
            transmitted to the AI model provider selected in the app in order to
            generate the answer. Account data (email address) is used for
        ...
        <section>
          <h2 className="text-lg font-semibold">5. Sharing and sale of data</h2>
          <p className="mt-2">
            We do not sell your personal data, we do not use it for advertising,
            and we do not share it with third parties except (a) the AI model
            providers needed to answer your queries, (b) hosting and
            infrastructure providers (Vercel, Firebase/Google Cloud), and (c)
            when required by law.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold">6. Deletion and control</h2>
          <ul className="mt-2 list-disc space-y-1 pl-6">
            <li>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            updated. Continued use of the Service after changes means you accept
            the updated policy.
          </p>
        </section>
